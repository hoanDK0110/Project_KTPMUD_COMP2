    ...
    <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">
                    Cập nhật Mainboard - Bo mạch chủ
                </header>
                ...
                <div class="panel-body">
                    ...
                    <div class="position-center">
                        ...
                        <form role="form" action="{{URL::to('update-mainboard'.$pro->product_id) }}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <input type="hidden" name="mainboard_category" value="mainboard">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Tên mainboard</label>
                                <input type="text" name="mainboard_name" class="form-control" id="exampleInputEmail1" value="{{ $pro->product_name }}">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Giá sản phẩm</label>
                                <input type="text" name="mainboard_price" class="form-control" id="exampleInputEmail1" value="{{ $pro->product_price }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="mainboard_image" class="form-control" id="exampleInputEmail1" value="{{ $pro->product_image }}">
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail1">Hình khác</label>
                                <input type="text" name="mainboard_imgOther" class="form-control" id="exampleInputEmail1" value="{{ $pro->product_imgOther }}">
                            </div>

                            <div class="form-group">
                                <label for="exampleInputPassword1">Mô tả</label>
                                <textarea style="resize: none" rows = "8" class="form-control" name="mainboard_desc" id="ckeditor" placeholder="Mô tả">{{ $pro->product_desc }}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Thông số kỹ thuật</label>
                                <textarea style="resize: none" rows = "8" class="form-control" name="mainboard_spec" id="ckeditor1" placeholder="Thông số kỹ thuật">{{ $pro->product_spec }}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Số lượng sản phẩm</label>
                                <input type="number" name="mainboard_quantity" class="form-control" id="exampleInputEmail1" value="{{ $pro->product_quantity }}">
                            </div>
                            <div class="form-group">
                            ...
                            <button type="submit" name="add_mainboard " class="btn btn-info">Cập nhật Sản Phẩm</button>
                        </form>
                        @endforeach
                    </div>
