        ...
        <tbody>
            @foreach ($all_product as $key => $pro)
                <tr>
                    ...
                    @endphp
                    <td>{{ $details['brand'] }}</td>
                    <td>{{ $details['wattage'] }}</td>
                    <td>{{ $details['80plus'] }}</td>
                    <td>{{ $details['type'] }}</td>
                    ...
                    <td>
                        <a href="{{ URL::to('/edit-psu/'.$pro->product_id) }}" class="active styling-edit" ui-toggle-class="">
